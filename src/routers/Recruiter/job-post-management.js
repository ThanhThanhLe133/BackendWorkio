...
router.get("/job-post", controllers.getJobPostDetailRecruiter);
router.get(
    "/candidates-of-job-post",
    controllers.getAllCandidatesOfPostRecruiter,
);
router.get(
    "/suggested-candidates",
    controllers.suggestCandidatesForJobRecruiter,
);
